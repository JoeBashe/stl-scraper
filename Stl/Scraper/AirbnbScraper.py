...
class AirbnbScraper:
    def __init__(self, explore: Explore, pdp: Pdp, reviews: Reviews, logger: Logger):
    ...
    def run(self, query: str):
        ...
        self.__save_csv(query, listings)

    @staticmethod
    def __save_csv(query: str, listings: list):
        with open('{}.csv'.format(query), 'w') as csvfile:
